use std::{collections::HashSet, fs::File, io::{BufRead, BufReader, Write}};
...
pub fn reading_in() -> Vec<Vec<String>>{
    ...
    for line in reader.lines() {
        ...
        let lines: String = String::from(line.unwrap());
